...
/**
 * Aplet kalkulatora emerytalnego posiadaj¹cy
...
public class Retire extends JApplet
{
   ...
   public void initUI()
   {
      ...
      for (int i = 0; i < locales.length; i++)
         // jeœli bie¿¹cy lokalizator jest jednym z mo¿liwych do wyboru, to zostaje wybrany
...
class RetireInfo
{
    ...
    * @param x wysokoœæ inflacji w procentach
    */
    ...
    * @param x zwrot inwestycji w procentach
    */
