...
/**
 * Program wyznaczaj¹cy wyra¿enia XPath.
...
/**
 * Ramka prezentuj¹ca dokument XML document oraz posiadaj¹ca pola
 * umozliwiaj¹ce wpisanie wyra¿enia i wyœwietlenie wyniku.
 */
class XPathFrame extends JFrame
{
   ...
   public void evaluate()
   {
      ...
      catch (Exception e) // wyj¹tek refleksji
      {
         e.printStackTrace();
      }
   }
