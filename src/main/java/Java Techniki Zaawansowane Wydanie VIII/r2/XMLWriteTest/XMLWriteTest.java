...
/**
 * Ramka zawieraj¹ca panel prezentacji grafiki.
 */
class XMLWriteFrame extends JFrame
{
   ...
   /**
    * Zapisuje grafikê w formacie SVG u¿ywaj¹c DOM/XSLT.
    */
   ...
   /**
    * Zapisuje grafikê w formacie SVG u¿ywaj¹c StAX.
    */
...
/**
 * rysuj¹cy sekwencjê kolorowych prostok¹tów.
 */
class RectangleComponent extends JComponent
{
   ...
   /**
    * Tworzy dokument SVG dla bie¿¹cego rysunku.
   ...
   /**
    * Zapisuje dokument SVG dla bie¿¹cego rysunku.
   ...
   /**
    * Zamienia obiekt klasy Color na wartoœæ szesnastkow¹.
    * @param c obiekt klasy Color 
    * @return ³añcuch postaci #rrggbb
    */
