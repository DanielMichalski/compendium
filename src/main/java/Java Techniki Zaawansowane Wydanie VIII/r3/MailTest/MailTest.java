 ...
 * Program demonstruj¹cy u¿ycie gniazdek
   do wysy³ania tekstowych wiadomoœci poczty elektronicznej.
...
class MailTestFrame extends JFrame
{
   ...
   /**
    * Wysy³a wiadomoœæ poczty elektroniczej utworzon¹ przez u¿ytkownika.
    */
   ...
   /**
    * Odbiera ³añcuch znaków z gniazdka
