...
/**
 * Program demonstruj¹cy zastosowanie klasy URLConnection do wys³ania ¿¹dania POST.
...
{
   /**
    * Wysy³a ¿¹danie POST i zwraca odpowiedŸ serwera.
    * @param urlString URL serwera
    * @param nameValuePairs mapa par nazwa/wartoœæ dostarczanych w ¿¹daniu 
    * @return odpowiedŸ serwera (ze strumienia wejœciowego lub strumienia b³êdów)
    */
