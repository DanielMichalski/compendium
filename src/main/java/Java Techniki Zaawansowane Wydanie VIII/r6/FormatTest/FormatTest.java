...
/**
 * Program testuj¹cy dzia³anie sformatowanych pól tekstowych
...
/**
 * Ramka zawieraj¹ca kolekcjê sformatowanych pól tekstowych
 * oraz przycisk wyœwietlaj¹cy ich wartoœci.
 */
class FormatTestFrame extends JFrame
{
   ...
   /**
    * Dodaje wiersz w g³ównym panelu.
    * @param labelText etykieta pola
    * @param field przyk³adowe pole
    */
...
/**
 * Filtr ograniczaj¹cy dane wejœciowe
...
/**
 * Weryfikator sprawdzaj¹cy zawartoœæ pola tekstowego.
 */
...
/**
 * Obiekt formatuj¹cy 4-bajtowe adresy IP postaci a.b.c.d
 */
