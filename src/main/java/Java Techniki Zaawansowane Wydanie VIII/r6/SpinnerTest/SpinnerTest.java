...
/**
 * Program testuj¹cy komponent JSpinner.
...
/**
 * Ramka z panelem zawieraj¹cym kilka komponentów JSpinner
...
class SpinnerFrame extends JFrame
{
   ...
   /**
    * Dodaje wiersz do g³ównego panelu.
    * @param labelText etykieta komponentu JSpinner
    * @param spinner przyk³adowy komponent JSpinner
    */
...
/**
 * Model dynamicznie generuj¹ce permutacje s³owa
 */
class PermutationSpinnerModel extends AbstractSpinnerModel
{
   /**
    * Tworzy model.
    * @param w permutowane s³owo
    */
