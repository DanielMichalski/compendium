 ...
 * innego certyfikatu znajduj¹cego siê w sk³adnicy.
...
public class CertificateSigner
{
   public static void main(String[] args)
   {
      ...
      String inname = null; // nazwa pliku wejœciowego
      String outname = null; // nazwa pliku wyjœciowego
   ...
   /**
    * Wyœwietla komunikat o sposobie uruchomienia programu
    * i koñczy jego dzia³anie.
    */
