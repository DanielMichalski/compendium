...
/**
 * Aplet ten mo¿e zostaæ uruchomiony poza "piaskownic¹" 
 * i czytaæ lokalne pliki, jeœli udzielimy mu odpowiedniego pozwolenia.
...
public class FileReadApplet extends JApplet
{
   ...
   /**
    * £aduje zawartoœæ pliku do obszaru tekstowego.
