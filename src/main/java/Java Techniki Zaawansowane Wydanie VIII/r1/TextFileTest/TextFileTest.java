...
public class TextFileTest
{
   public static void main(String[] args)
   {
      ...
      try
      {
         ...
         // wyœwietla wszystkie wczytane rekordy
   ...
   /**
    * Zapisuje dane wszystkich obiektów Employee
    * umieszczonych w tablicy
    * do obiektu PrintWriter
    * @param employees tablica obiektów Employee
    * @param out obiekt PrintWriter
    */
   private static void writeData(Employee[] employees, PrintWriter out) throws IOException
   {
      // zapisuje liczbê obiektów
   ...
   /**
    * Wczytuje tablicê obiektów Employee
    * @param in obiekt Scanner
    * @return tablica obiektów Employee
    */
