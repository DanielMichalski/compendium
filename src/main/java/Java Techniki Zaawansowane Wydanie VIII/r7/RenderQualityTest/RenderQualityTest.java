...
/**
 * Ramka zawieraj¹ca przyciski wyboru wskazówek
...
class RenderQualityTestFrame extends JFrame
{
   ...
   /**
    * Tworzy zbiór przycisków wyboru wskazówek
      @param key nazwa klucza
      @param value1 nazwa pierwszej wartoœci dla klucza
      @param value2 nazwa drugiej wartoœci dla klucza
    */
...
/**
 * Komponent tworz¹cy rysunek z zastosowaniem wskazówek.
 */
