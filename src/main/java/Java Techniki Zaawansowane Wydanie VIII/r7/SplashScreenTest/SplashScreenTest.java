...
/**
 * Program demonstruj¹cy sposób u¿ycia ekranu powitalnego.
...
public class SplashScreenTest
{
   ...
   /**
    * Metoda rysuj¹ca na ekranie powitalnym.
    */
   private static void init1()
   {
      ...
      try
      {
         ...
         {
            drawOnSplash(i);
            Thread.sleep(100); // symuluje ³adowanie aplikacji
         }
      }
   ...
   /**
    * Metoda wyœwietlaj¹ca ramkê o tej samej zawartoœci
    * co ekran powitalny.
    */
      ...
      new SwingWorker<Void, Integer>()
      {
         ...
         protected void process(List<Integer> chunks)
         {
            for (Integer chunk : chunks)
            {
               ...
               splashPanel.repaint(); // poniewa¿ obrazek zosta³ za³adowany asynchronicznie
            }
         }
