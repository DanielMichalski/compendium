...
/**
 * Ramka posiadaj¹ca menu umo¿liwiaj¹ce za³adowanie obrazu z pliku
 * i wybór operacji oraz komponent przedstawiaj¹cy wynik operacji.
 */
class ImageProcessingFrame extends JFrame
{
    ...
    * Stosuje filtr obrazu i odrysowuje obraz.
      @param op rodzaj przekszta³cenia
    */
   ...
   /**
    * Wykonuje operacjê splotu i odrysowuje obraz.
      @param elements j¹dro splotu (tablica zawieraj¹ca 9 elementów macierzy)
    */
