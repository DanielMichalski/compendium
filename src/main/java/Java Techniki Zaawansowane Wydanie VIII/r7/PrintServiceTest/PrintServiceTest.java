...
/**
 * Program demonstruj¹cy wykorzystanie us³ug drukowania.
 * Drukuje obrazek w formacie GIF za pomoc¹ jednej z us³ug
 * dostêpnych dla tego rodzaju dokumentu (wybranej przez u¿ytkownika).
