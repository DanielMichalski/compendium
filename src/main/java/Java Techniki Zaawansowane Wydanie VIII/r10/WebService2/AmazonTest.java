...
/**
 * Klient korzystaj¹cy z us³ugi Amazon.
...
/**
 * Ramka umo¿liwiaj¹ca wybór autora ksi¹¿ki i wyœwietlaj¹ca odpowiedŸ serwera.
 */
class AmazonTestFrame extends JFrame
{
   ...
   /**
    * Wywo³uje us³ugê Web firmy Amazon 
    * w celu wyszukania tytu³ów podanego autora.
    * @param name nazwisko autora
    * @return opis tytu³ów
    */
